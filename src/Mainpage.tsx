...
import { Card, Layout, List, Menu, Modal } from 'antd';
...
export const MainPage = () => {
  ...
  useEffect(() => {
    ...
    trajectories
      .get(selectedMap)!
      .find(
        (PlayerTrajectory: AgentTrajectory) =>
          PlayerTrajectory.agent === selectedAgent
      )
    ...
    <Layout style={{ height: '100vh' }}>
      ...
      <StyledContent>
        ...
        <Footer style={{ textAlign: 'center' }}>
          <div>Created by Thomas Legrand ©{new Date().getFullYear()}</div>
          <div>
